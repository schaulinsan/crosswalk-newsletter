export default function decorate(block) {
  ...
  return `
    <mj-section mj-class="mj-hero" background-url="${img.src}">
        <mj-column width="100%">
            <mj-section mj-class="mj-hero-content" background-url="/icons/hero-background.png">
                <mj-column width="100%" align="left">
                    <mj-image align="left" mj-class="mj-hero-image" src="/icons/logo.png" />
                    <mj-text mj-class="mj-hero-text" width="40%">${h1.innerHTML}</mj-text>
                </mj-column>
                <mj-column width="0%">
